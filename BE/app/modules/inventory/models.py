...
class WarehouseImportRequirement(Base):
    ...
    quantity = Column(Integer, nullable=True)
    box_scan_progress = Column(Integer, nullable=True)
    ...
    inventory_code = Column(String(50), nullable=True)
    approver = Column(String(10), nullable=True)
...
class InternalWarehouseTransferRequest(Base):
    ...
    don_vi_linh = Column(String(255), nullable=True)
    don_vi_nhan = Column(String(255), nullable=True)
