...
export const routes: Routes = [
  ...
  {
    path: 'kho-thanh-pham/chuyen-kho-noi-bo/detail/:id/scan/:reqId',
  ...
  {
    path: 'kho-thanh-pham/nhap-kho-sx/phe-duyet/:id/scan/:reqId',
  ...
  {
    path: 'kho-thanh-pham/xuat-don-ban-hang/detail/:id/scan/:reqId',
